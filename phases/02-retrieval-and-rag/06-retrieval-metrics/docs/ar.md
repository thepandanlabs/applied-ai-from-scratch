...
> **اختبار من الواقع:** يراجع مدير المنتج لديك المخرجات ويقول: "النتائج تبدو لي ذات صلة لما أتصفّحها، ليش نحتاج كل هذي الأرقام؟ ماذا يقول لنا المقياس ولا يقوله فحص بشري عشوائي؟" كيف تشرح ما الذي تلتقطه المقاييس وتُفوّته معاينة بضع نتائج بالعين، خصوصًا حين يتغيّر النظام أو المجموعة عبر الزمن؟
