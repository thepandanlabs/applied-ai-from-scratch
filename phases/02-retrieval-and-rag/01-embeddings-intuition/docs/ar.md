...
أنت تبني روبوت دردشة للدعم الفني. المستخدمون يطرحون أسئلتهم بلغة طبيعية. لديك 10,000 مقالة دعم. أول طريقة تخطر على البال هي البحث بالكلمات المفتاحية (keyword search): لكن البحث بالكلمات المفتاحية يفشل في اللحظة التي يكتب فيها المستخدم "تطبيقي ما يشتغل" بينما الجواب يقبع في مقالة عنوانها "Application Launch Failure Troubleshooting".
...
> **اختبار من الواقع:** مؤسّسك غير التقني ينظر إلى هذا ويقول: "بحثنا يلقى الكلمات المفتاحية تمام، ليش نحتاج كل رياضيات الأشعّة هذي؟" كيف تشرح، بكلمات بسيطة، ما الذي يعجز عنه البحث بالكلمات المفتاحية وما الذي يجلبه هذا فعليًا للعمل؟
...
> **نقلة في المنظور:** مهندس مهتمّ بالتكلفة في فريقك يقول: "تحميل النموذج هذا 80MB واحنا بس نسوي بحث. ليش ما نستخدم أنماط regex أو فهرس كلمات مفتاحية جيد بدلًا منه؟ هل هذا ضروري فعلًا، ولا نبالغ في الهندسة؟" ما جوابك الصادق، ومتى قد يكون محقًّا فعلًا؟
