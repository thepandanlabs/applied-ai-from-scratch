...
> **اختبار من الواقع:** عالم بيانات في فريقك يقول: "بحثنا الدلالي كان يعمل بشكل جيد لمعظم الاستعلامات. أي فشل محدّد لدينا الآن يبرّر إضافة فهرس BM25 كامل، وفهرس معكوس، ومنطق دمج RRF، وعبء الصيانة الإضافي؟ هل يمكنك أن تُريني استعلامًا حقيقيًا كان معطوبًا من قبل ويعمل الآن؟" كيف تجيب، وكيف تجد تلك الاستعلامات إن لم تكن لديك بعد؟
