...
> **اختبار من الواقع:** مهندس بيانات في فريقك يقول: "نحن نقسّم أصلًا على أسطر جديدة (newlines) في خطّ ETL وهو يعمل بشكل جيد للبيانات المُهيكلة. فلماذا نحتاج إلى كل هذه الاستراتيجيات؟ أليس هذا مجرد تعقيد زائد؟" كيف تشرح متى يكون التقسيم على الأسطر مناسبًا فعلًا ومتى يسبّب إخفاقات استرجاع تبدو كمشاكل نموذج؟
