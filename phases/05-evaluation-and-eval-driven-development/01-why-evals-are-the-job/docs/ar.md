...
ورثتَ بوت دعم عملاء. ترك المهندس السابق رسالة على Slack: "اختبرته بدقة كافية وبدا جيداً." بعد ستة أسابيع ينشر مستخدم لقطة شاشة للبوت وهو ينصحه بالتواصل مع منافس. تُرجِع النظام إلى نسخة الأسبوع الماضي. والآن أصبح يعطي إجابات خاطئة عن سياسة الاسترجاع. أيّ نسخة أفضل؟ لا تعلم. لا تملك أي بيانات.
