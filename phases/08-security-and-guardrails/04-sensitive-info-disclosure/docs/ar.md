...
> **اختبار من الواقع:** يصطاد الـ OutputFilter لديك جزءًا من الـ system prompt في استجابة النموذج ويحجبه. يرى المستخدم "[REDACTED]" في منتصف الجملة. صار يعرف الآن: (1) أن ثمة system prompt، (2) أن المرشّح وجد شيئًا، (3) أن الجملة المحجوبة تدلّه تقريبًا على أين يستكشف بعد ذلك. ماذا يعني هذا لتصميم استراتيجية استجابة المرشّح؟
